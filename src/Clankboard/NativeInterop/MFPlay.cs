...
namespace Clankboard.NativeInterop.MFPlay;
...
internal class MFPlayTools
{
    ...
    public static extern HRESULT MFPCreateMediaPlayer(string pwszURL, bool fStartPlayback,
...
public interface IMFPMediaItem
{
    ...
    HRESULT GetStartStopPosition(out Guid pGuidStartPositionType, out PROPVARIANT pvStartValue,
        out Guid pGuidStopPositionType, out PROPVARIANT pvStopValue);

    HRESULT SetStartStopPosition(ref Guid pGuidStartPositionType, PROPVARIANT pvStartValue,
        ref Guid pGuidStopPositionType, PROPVARIANT pvStopValue);
...
public interface IPropertyStore
{
    ...
    HRESULT GetValue([In] [MarshalAs(UnmanagedType.Struct)] ref PROPERTYKEY key,
        [Out] [MarshalAs(UnmanagedType.Struct)] out PROPVARIANT pv);

    HRESULT SetValue([In] [MarshalAs(UnmanagedType.Struct)] ref PROPERTYKEY key,
