...
namespace Clankboard.NativeInterop.NativeStructs;
...
public struct PROPVARIANT
{
    ...
    [FieldOffset(8)] public IntPtr pclsidVal; // GUID ID pointer
    [FieldOffset(8)] public IntPtr pszVal; // Ansi string pointer
    [FieldOffset(8)] public IntPtr pwszVal; // Unicode string pointer
    [FieldOffset(8)] public IntPtr punkVal; // punkVal (interface pointer)
...
public struct PROPERTYKEY
{
    ...
    public static readonly PROPERTYKEY PKEY_FileVersion = new(new Guid("0CEF7D53-FA64-11D1-A203-0000F81FEDEE"), 4);
}
